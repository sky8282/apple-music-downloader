			...
			for attempt := 1; attempt <= PostDownloadMaxRetries; attempt++ {
				...
				if postDownloadError == nil {
					...
					if lyricAccount != nil && (core.Config.EmbedLrc || core.Config.SaveLrcFile) && trackData.Type != "music-videos" {
						lrcStr, lrcErr := lyrics.Get(storefront, trackData.ID, core.Config.LrcType, core.Config.Language, core.Config.LrcFormat, core.DeveloperToken, lyricAccount.MediaUserToken, core.Config.EnableTranslation, core.Config.TranslationLanguage)
						if lrcErr == nil {
