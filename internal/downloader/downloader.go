...
func downloadTrackSilently(track structs.TrackData, meta *structs.AutoGenerated, albumId, storefront, baseSaveFolder, Codec, covPath string, account *structs.Account, progressChan chan runv14.ProgressUpdate) (string, error) {
	if track.Type == "music-videos" {
		...
		mvOutPath, err := MvDownloader(track.ID, baseSaveFolder, sanitizedSingerFolder, sanitizedAlbumFolder, storefront, meta, account, progressChan)
		if err != nil {
...
func MvDownloader(adamID string, baseSaveDir, artistDir, albumDir string, storefront string, meta *structs.AutoGenerated, account *structs.Account, progressChan chan runv14.ProgressUpdate) (string, error) {
